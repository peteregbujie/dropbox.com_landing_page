 ...
 return (
  <section className="bg-[#1E1919] text-white h-50rem]">
   <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    ...
    <div className="z-10 flex justify-between pt-8">
     <h2 className="text-3xl font-bold sm:text-4xl ">
      For all things worth sharing.
     </h2>
     <button className="flex items-center justify-between px-4 py-6 w-[300px] text-lg text-gray-800 bg-blue-600 hover:opacity-75">
      Explore plans
